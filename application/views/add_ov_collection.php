			...
			<div class="row">
				<div class="title-button-secondary-container clearfix">
					<div class="title-container">
						<h3 class="title">Add New OVI Collection</h3>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="form-main-container">
		<div class="container">
			<div class="row">
				...
				site_url('FieldActivitiesController/saveOviCollection'); ?>" onSubmit="return formValidation()">
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="date" id="collect-date" name="collect-date" class="form-control" max="<?php echo date("Y-m-d"); ?>" required>
						</div>
					</div>
					<div class="element-row clearfix">
						<div class="col-md-2">
						...
						<div class="col-md-6">
							<input type="time" id="collect-time" name="collect-time" class="form-control" required>
						</div>
					</div>
...
<script type="text/javascript">
	function formValidation() {
		...
		var trap_id = document.getElementById("ovi-trap-id").value;
		...
		document.getElementById("ovi-trap-id").style.borderColor="#ccc";
		document.getElementById("collection-status").style.borderColor="#ccc";

		var error_flag = 0;
		if(trap_id==false){
			error_flag=1;
			document.getElementById("ovi-trap-id").style.borderColor="red";
