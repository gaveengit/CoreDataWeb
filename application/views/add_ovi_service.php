				...
				<ul class="breadcrumb">
					...
					<li><a class="#"
						   onclick="location.href='<?php echo site_url('FieldActivitiesController/oviServices'); ?>'">OVI
							Service</a></li>
					<li><a class="selected">Add OVI Service</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="title-button-secondary-container clearfix">
					<div class="title-container">
						<h3 class="title">Add New OVI Service</h3>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="form-main-container">
		<div class="container">
			<div class="row">
				...
				site_url('FieldActivitiesController/saveOviService'); ?>" onsubmit="return formValidation()">
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="date" id="service_date" name="service_date" class="form-control" max="<?php echo date("Y-m-d"); ?>" required>
						</div>
					</div>
					<div class="element-row clearfix">
						<div class="col-md-2">
