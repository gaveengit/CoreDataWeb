	...
	<div class="form-main-container">
		<div class="container">
			<div class="row">
				...
				site_url('ScreeningController/saveScreening'); ?>" onsubmit="return formvalidation()">
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							...
							<div id="identificationid-error-container" style="display: none;color: red;"></div>
						</div>
					</div>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="aedes_male_result"
								   ...
								   name="aedes_male_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="aedes_female_result"
								   ...
								   name="aedes_female_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="male_anopheles_result"
								   ...
								   name="male_anopheles_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="female_anopheles_result"
								   placeholder="Enter Female Anopheles Result"
								   name="female_anopheles_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="culex_male_result"
								   ...
								   name="culex_male_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="culex_female_result"
								   ...
								   name="culex_female_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="final_result"
								   ...
								   name="final_result" value="0" required>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							...
							<div id="screened-date-error-container" style="display: none;color: red;"></div>
						</div>
					</div>
					<div class="element-row clearfix">
						<div class="col-md-3">
						...
						<div class="col-md-6">
							<input type="time" id="screened_time" name="screened_time" class="form-control" required>
						</div>
					</div>
...
<script type="text/javascript">
	function formvalidation() {
		...
		var identification_id = document.getElementById("identification_id").value;
		...
		document.getElementById("identificationid-error-container").style.display = 'none';
		...
		document.getElementById("identification_id").style.borderColor = "#ccc";
		document.getElementById("final_result").style.borderColor = "#ccc";


		if (identification_id == false) {
			error_flag = 1;
			document.getElementById("identification_id").style.borderColor = "red";
			document.getElementById("identificationid-error-container").style.display = 'block';
			document.getElementById("identificationid-error-container").innerHTML = "Please select a diagnostic id.";
