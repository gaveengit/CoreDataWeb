		...
		<div class="container">
			<div class="row">
				<div class="title-container">
					<h3 class="title" align="center">Mosquito Diagnostic Report Generation</h3>
				</div>
				<div class="menu-container-secondary clearfix">
					<form role="form" method="post" action="<?php echo
					site_url('ReportController/goDiagnosticPerformanceReportView'); ?>" onSubmit="return formValidation()">
