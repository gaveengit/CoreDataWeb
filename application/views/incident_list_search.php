		...
		<div class="container">
			<div class="row">
				<ul class="breadcrumb">
					...
					<li><a href="#" onclick="location.href='<?php echo site_url('IncidentController'); ?>'">Field
							Incidents</a></li>
					<li><a class="selected">Field Incidents Search</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="search-bar-secondary-container clearfix">
					...
					site_url('IncidentController/incidentSearch'); ?>">
						<div class="col-md-8">
							<div class="row">
								<input type="text" class="form-control search-bar" name="search_bar"
									   placeholder="Search by member name, address, date, time"  value="<?php echo $search_key[0] ?>"/>
							</div>
						</div>
						<div class="col-md-2">
