			...
			<div class="row">
				<ul class="breadcrumb">
					...
					<li><a href="#" onclick="location.href='<?php echo site_url('ReportController'); ?>'">Reports
							Menu</a></li>
					<li><a class="selected">MRC Performance Report Generation</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="title-container">
					<h3 class="title" align="center">MRC Performance Report Generation</h3>
				</div>
				<div class="menu-container-secondary clearfix">
					<form role="form" method="post" action="<?php echo
					site_url('ReportController/goMrcPerformanceReportView'); ?>" onSubmit="return formValidation()">
