			...
			<div class="row">
				<ul class="breadcrumb">
					...
					<li><a class="#" onclick="location.href='<?php echo site_url('FieldActivitiesController'); ?>'">Field
							Activities</a></li>
					<li><a class="#" onclick="location.href='<?php echo site_url('FieldActivitiesController/ovLocations'); ?>'">OVI Locations</a></li>
					<li><a class="selected">OVI Locations Search</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="search-bar-secondary-container clearfix">
					...
					site_url('FieldActivitiesController/oviLocationsSearch'); ?>">
						<div class="col-md-8">
							<div class="row">
						...
						foreach ($data as $row) {
							if (($i % 2) != 0) {
								...
								echo "<td class='run-name-cell' onclick=" . "location.href=" . "'" .
										site_url('FieldActivitiesController/updateOvLocations/') . $row->trap_id . "'" . ">" . "<span value=" . $row->trap_id . ">" . "View" . "</span></td>";
								echo "<td class='run-name-cell' onclick=" . "if(confirm(confirm_delete_message))" . "location.href=" . "'" .
										site_url('FieldActivitiesController/deleteOviLocation/') . $row->trap_id . "'" . ">" . "<span value=" . $row->trap_id . ">" . "Delete" . "</span></td>";
								echo "</tr>";
								$i++;
							} else {
