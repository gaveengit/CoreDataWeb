					...
					<div class="date-container clearfix">
						<div class="col-md-6" style="text-align: center;">
							<div class="form-group">
								<label for="email" style="font-size:15px;">Date From: 2021/03/30</label>
							</div>
						</div>
						<div class="col-md-6" style="text-align: center;">
							<div class="form-group">
								<label for="email" style="font-size:15px;">Date To: 2021/04/15</label>
							</div>
						</div>
					</div>
					<div class="title-container">
						...
						<div>
							<table style="border-collapse: collapse;width:100%;">
								...
								<tr style="border-bottom: 0.5px solid ;background-color: lightgreen;">
									...
									<td style="padding-top: 15px;padding-bottom: 15px;">10</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">20%</td>
								</tr>
								<tr style="border-bottom: 0.5px solid ;background-color: lightgreen;">
									<td style="padding-top: 15px;padding-bottom: 15px;">Set traps</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">40</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">80%</td>
								</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="date-container clearfix">
						<div>
							<table style="border-collapse: collapse;width:100%;">
								...
								<tbody>
								<tr style="border-bottom: 0.5px solid ;background-color: lightgreen;">
									<td style="padding-top: 15px;padding-bottom: 15px;">Exclusions with Replacements
									</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">20</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">40%</td>
								</tr>
								<tr style="border-bottom: 0.5px solid ;background-color: lightgreen;">
									<td style="padding-top: 15px;padding-bottom: 15px;">No of set traps</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">30</td>
									<td style="padding-top: 15px;padding-bottom: 15px;">60%</td>
								</tr>
								</tbody>
							</table>
						</div>
