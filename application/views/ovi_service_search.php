				...
				<ul class="breadcrumb">
					...
					<li><a class="#"
						   onclick="location.href='<?php echo site_url('FieldActivitiesController/oviServices'); ?>'">OVI
							Services</a></li>
					<li><a class="selected">OVI Services Search</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="search-bar-secondary-container clearfix">
					...
					site_url('FieldActivitiesController/searchOviServices'); ?>">
						<div class="col-md-8">
							<div class="row">
