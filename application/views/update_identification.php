				...
				<div class="form-main-container">
					<div class="container">
						<div class="row">
							...
							site_url('DiagnosticsController/saveUpdateIdentification'); ?>" onsubmit="return formvalidation()">
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" id="identification_id"
											   ...
											   name="identification_id" value="<?php echo $data[0]->identification_id ?>" readonly>
									</div>
								</div>
							...
							';
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="number" class="form-control" id="aedes_male_count"
											   ...
											   name="aedes_male_count" value="<?php echo $data[0]->male_aedes_aegypti_count ?>" required>
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="number" class="form-control" id="aedes_female_count"
											   ...
											   name="aedes_female_count" value="<?php echo $data[0]->female_aedes_aegypti_count ?>" required>
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="number" class="form-control" id="male_anopheles_count"
											   ...
											   name="male_anopheles_count" value="<?php echo $data[0]->male_anopheles_count ?>" required>
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="number" class="form-control" id="female_anopheles_count"
											   placeholder="Enter Female Anopheles Count"
											   name="female_anopheles_count" value="<?php echo $data[0]->female_anopheles_count ?>" required>
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="number" class="form-control" id="culex_male_count"
											   ...
											   name="culex_male_count" value="<?php echo $data[0]->male_culex_count ?>" required>
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										<input type="number" class="form-control" id="culex_female_count"
											   ...
											   name="culex_female_count" value="<?php echo $data[0]->female_culex_count ?>" required>
								...
								<div class="element-row clearfix">
									...
									<div class="col-md-6">
										...
										value="<?php echo $data[0]->identified_date ?>" max="<?php echo date("Y-m-d"); ?>" required>
									</div>
								</div>
								<div class="element-row clearfix">
									<div class="col-md-3">
									...
									<div class="col-md-6">
										...
										value="<?php echo $data[0]->identified_time ?>" required>
									</div>
								</div>
