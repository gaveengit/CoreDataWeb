...
<body>
<div class="update-mrc-main-container">
				...
				<ul class="breadcrumb">
					...
					<li><a class="#"
						   onclick="location.href='<?php echo site_url('FieldActivitiesController/mrcLocations'); ?>'">MRC
							Locations</a></li>
					<li><a class="selected">Update MRC Location</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="title-button-secondary-container clearfix">
					<div class="title-container">
						<h3 class="title">Update MRC Location</h3>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="form-main-container">
		<div class="container">
			<div class="row">
				...
				site_url('FieldActivitiesController/saveUpdateMrc'); ?>" onSubmit="return formValidation()">
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<select class="form-control" id="status"
									name="status">
								<option value="1" <?php if ($data[0]->mrc_status == '1'): ?> selected="selected"<?php endif; ?>>
									Proposed
								</option>
					...
					<div class="element-row clearfix">
						...
						<div class="col-md-6">
							<input type="date" class="form-control" id="mrc-date" placeholder="Enter Date"
								   name="mrc-date" value="<?php echo $data[0]->mrc_date ?>" max="<?php echo date("Y-m-d"); ?>" readonly>
						</div>
					</div>
					<div class="element-row clearfix">
						<div class="col-md-2">
						...
						<div class="col-md-6">
							<input type="time" class="form-control" id="mrc-time" placeholder="Enter Time"
								   name="mrc-time" value="<?php echo $data[0]->mrc_time ?>" readonly>
						</div>
					</div>
					<div class="element-row clearfix">
						<div class="col-md-2">
